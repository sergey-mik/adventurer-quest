namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Robe ColorfulRobe { get; init; }
        ...
        {
            return $"{Name} is wearing a {string.Join(", ", ColorfulRobe.Colors)} robe that is {ColorfulRobe.Length} inches long and a {Hat.ShininessDescription} hat.";
        }
